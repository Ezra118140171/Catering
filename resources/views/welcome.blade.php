                    ...
                    <nav class="block static max-w-full">
                        <ul class="flex">
                            @if (Route::has('login'))
                                ...
                                <li>
                                    <a href="#location" class="py-2 mx-6 text-lg font-bold text-white">Menu</a>
                                </li>
                                <li>
                                    <a href="#location" class="py-2 mx-6 text-lg font-bold text-white">Langganan</a>
                                </li>
                                <li>
                                    <a href="#location" class="py-2 mx-6 text-lg font-bold text-white">Pesanan</a>
                                </li>
                                <li>
