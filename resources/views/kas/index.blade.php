<x-app-layout>
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="mt-4 mx-4 flex justify-end">
            <a href="{{ route('kas.export') }}" class="inline-flex items-center py-2 px-3 text-md font-medium text-center text-white bg-emerald-500 rounded-lg hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-blue-300">
                    ...
                    @foreach($kas as $item)
                        ...
                        <td class="border px-6 py-2">
                            <div class="flex justify-center gap-3">
                                ...
                                <a href="{{ route('kas.edit', ['kas' => $item->id_kas]) }}"
                                ...
                                <a href="{{ route('kas.show', ['kas' => $item->id_kas]) }}"
