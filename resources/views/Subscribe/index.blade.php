...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        {{-- foto --}}
        <div class="mt-28 bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="w-[80%] mx-auto" style="width: 85%;">
                <p class="text-4xl mt-6">Total Harga Pesanan</p>
                ...
                <div class="mt-4 mb-4" style="width: 90%;">
                    ...
                    <p class="text-4xl mt-6 mb-9">Metode Pembayaran</p>
                    <div class="flex">
                        <div class="mx-auto">
                            ...
                            <div class="flex pb-8">
                                <div class=" items-center justify-center " style="width: 672px;">
                                    <label for="dropzone-file" class="flex flex-col items-center justify-center w-full border-2 border-gray-300 border-solid rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-3 00 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-300">
                                        <div class="flex flex-col items-center justify-center " style="height: 50px;">
                                            <input id="dropzone-file" type="file" class="hidden" />
                                        </div>
                                    </label>
                                </div>
                                <button type="button" class="text-white bg-emerald-600 border border-gray-300 focus:outline-none hover:bg-emerald-800 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-2 py-2.5 mr-2 mb-2   dark:border-gray-600 dark:focus:ring-gray-700" style="margin-left:30px" onclick="$('#dropzone-file').click()" data-modal-toggle="defaultModal">Upload</button>
                            </div>

                            <div class="pb-5" style="padding-bottom: 70px;">
                                <div class="relative" style="width: 100%;">
                                    <a href="{{ route('welcome') }}">
                                        <button type="button" id="payment" class="focus:outline-none absolute right-0 text-white bg-emerald-600 hover:bg-emerald-800 focus:ring-4  focus:ring-green-300 font-medium rounded-lg text-2xl px-3 py-1  mb-2 dark:bg-emerald-600 dark:hover:bg-green-700 dark:focus:ring-green-800" style="width:192px">Pesan</button>
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="defaultModal" tabindex="-1" data-modal-placement="top-center" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 p-4 w-full md:inset-0 h-modal md:h-full">
                        <div class="bg-white" style="width: 400px; border-radius: 20px;">
                            <div class="bg-emerald-700" style="height: 40px; width: 400px; border-radius: 20px 20px 0 0;"><i class="fa-regular fa-bell content-center text-5xl bg-yellow-200" style="border-radius: 50%; margin-left: 45%;"></i></div>
