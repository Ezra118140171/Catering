                    ...
                    <div class="mt-6 grid grid-cols-1 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
                        <div
                            ...
                            <a href="#" class="align-middle">
                                <img class="rounded-t-lg" src="{{ asset('img/'. $item->foto) }}">
                            </a>
                            <div class="p-5">
                                <h5 class="mb-3 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{{ $item->nama_makanan }}</h5>
                                <h2 class="mb-8 text-xl font-semibold tracking-tight text-gray-900 dark:text-white">{{ $item->harga }}</h2>
